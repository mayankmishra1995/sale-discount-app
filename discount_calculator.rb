...
def products
 puts "Please enter all the items purchased separated by a comma"
  ...
  create_product("milk") if $product_purchase.include?('milk')
  create_product( "bread") if $product_purchase.include?('bread')
  create_product("banana") if $product_purchase.include?('banana')
  create_product("apple") if $product_purchase.include?('apple')  
  display_bill_table
end
